...
@section('content')
    ...
    <div class="container-fluid-content-row">
        <div class="row">
            <div class="card bg-light col-md-12 elevation-4 text-dark">
                <h1 style="color:dimgray;" class="p-3 mb-5"> <i style=" font-size:25px;color: dimgray;"> Welcome
                        {{ Auth::user()->name }}!</i></h1>
                <h2 class="text-center"
                    style="font-size: 30px; margin:auto; position:relative; top: -25px; color:dimgray; text-shadow: 2px 2px #17a2b8;">
