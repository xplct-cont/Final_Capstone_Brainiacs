...
<div class="container-fluid-content-row">
    <div class="row">
        <div class="card bg-dark col-md-12 elevation-4 text-dark" style="position:relative; top: 100px;">
            ...
            <h3 class="" style="font-size: 18px; margin:auto; position:relative; top:-10px; color:white;">Talisay, Calape, Bohol<br></h3>
