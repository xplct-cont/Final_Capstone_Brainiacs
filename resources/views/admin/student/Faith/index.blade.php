        ...
        <div class="mx-auto" style="width:400px;">
            <form action="{{ route('faith-list') }}" method="GET" role="search">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control mr-2" name="faith" placeholder="Search Full Name"
                        id="faith">
                        ...
                        <div class="card-body">
                            <div class="" style="position: relative; top:-20px;">
                                <a class="btn btn-danger mt-2 ml-2" style=""
                                    href="{{ route('export_faithStudents_pdf') }}"><span class="fas fa-arrow-circle-down"
