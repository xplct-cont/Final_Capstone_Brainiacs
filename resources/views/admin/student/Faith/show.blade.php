...
@section('content')
<div class="p-1">
    <a class="fas fa-arrow-left" style="font-size:20px; color:blue;" href="{{ url('faith-students')}}"></a>
</div>
    <body>
        <h1 class="text-dark p-3"
        style="font-weight:normal; font-size: 25px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; ">
        Records of {{ $faithStud->lastname }}, {{ $faithStud->firstname }} from {{ $faithStud->year_section }}</h1>
    <hr>
...
@endif
        <div class="py-5">
            <div class="container">
                <div class="row hidden-md-up">
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <a href="{{ url('show-student-faith/' . $faithStud->id . '/student_information_sheet_faith') }}">
                                <div class="layer">
                                </div>
                                <div class="content">
                                    <div class="div">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <a
                                href="{{ url('show-student-faith/' . $faithStud->id . '/counseling_anecdotal_record_faith') }}">
                                <div class="layer">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <a href="{{ url('show-student-faith/' . $faithStud->id . '/parent_conference_record_faith') }}">
                                <div class="layer">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <a href="{{ url('show-student-faith/' . $faithStud->id . '/career_interest_test_result_faith') }}">
                                <div class="layer">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <a href="{{ url('show-student-faith/' . $faithStud->id . '/personality_test_result_faith') }}">
                                <div class="layer">
        ...
        <form action="{{ url('/send_email_student_faith') }}" method="POST">
            @csrf
        <div class="input-group mb-3 mx-auto" style="width: 300px; margin-top: -30px;">
            <input type="email" name="email" class="form-control text-center" value="{{ $faithStud->email }}"
                required>
        </div>
            ...
            <div class="container " style="position: relative; top:-40px;">
                <div class="form-group">
                    ...
                    <input type="text" name="subject" class="form-control"
                        value="{{ $faithStud->firstname }} {{ $faithStud->middlename }} {{ $faithStud->lastname }}" required />
                </div>
