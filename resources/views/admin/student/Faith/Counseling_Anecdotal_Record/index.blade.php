...
<div class="p-1">
    ...
    <h1 class="text-dark p-3"
        ...
        Counseling Anecdotal Records of {{ $student_fai->lastname }}, {{ $student_fai->firstname }} from
        ...
        <div class="card">
            <div class="card-header text-center">
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ url('show-student-faith/' . $student_fai->id . '/counseling_anecdotal_record_faith/create/') }}"
                ...
                <table class="table table-striped table-sm text-dark text-center bg-light">
                    ...
                    <tbody>
                        @forelse ($counseling_anecdotal_faith as $coun_anec_fai)
                            <tr>
                                <td class="text-dark">{{ $coun_anec_fai->date_time_called->format('F d,  Y - g:i A') }}</td>
