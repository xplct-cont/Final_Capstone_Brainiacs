...
<div class="p-1">
    ...
    <h1 class="text-dark p-3"
        ...
        Personality Test Result of {{ $student_fai->lastname }}, {{ $student_fai->firstname }} from
    ...
    <div class="container" style="">
        <div class="">
            <div class="">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-secondary text-center">
                                    ...
                                    <form action="{{ url('/upload_personality_result_faith') }}" method="POST"
                ...
                @forelse ($personality_test_result_faith as $personal_fai)
                    <a href="{{ url('delete_personality_test_result_faith/' . $personal_fai->id) }}"
                        class="btn btn-sm btn-danger mb-1"><i class="text-light fas fa-trash"></i> Delete</a>
                    <a href="{{ route('download_personality_test_result_faith', $personal_fai->id) }}"
                        class="btn btn-sm btn-primary mb-1"><i class="text-light fas fa-download"></i> Download </a>
                    <img src="{{ asset('storage/personality_test_result/' . $personal_fai->personality_result) }} "
