            ...
            <div class="col-md-11 elevation-4 p-3 rounded  mt-2 bg-light mb-3">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <a class="btn btn-danger mt-2 ml-2 mr-2" style=""
                        href="{{ route('export_wisdomStudents_anecdotal_pdf', $student_wis->id) }}"><span
                ...
                <div class="container mx-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group ">
                                <label for="" style="color:dimgray">Home Address: </label>
                                <input type="text" class="form-control"  value="{{ $stud_info_wis->student->address}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="" style="color:dimgray">Age: </label>
                                <input type="text" class="form-control" name="age"  value="{{ $stud_info_wis->father_age}}">
                    ...
                    <p class="text-dark mt-2 mb-5"><i class="text-dark">I certify that all information above are true
                          ...
                          <div class="row">
                            <div class="col-md-4">
                                <label for="" style="color:dimgray">Date Signed: </label>
                                <input type="text" class="form-control" name="date_signed"  value="{{$stud_info_wis->date_signed->format('d-m-y')}}">
