        ...
        <div class="py-5">
            <div class="container">
                <div class="row hidden-md-up">
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <a href="{{ url('show-student-wisdom/' . $wisdomStud->id . '/student_information_sheet_wisdom') }}">
                                <div class="layer">
                                </div>
                                <div class="content">
                                    <div class="div">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <a href="{{ url('show-student-wisdom/' . $wisdomStud->id . '/anecdotal_record_wisdom') }}">
                                <div class="layer">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <a
                                href="{{ url('show-student-wisdom/' . $wisdomStud->id . '/counseling_anecdotal_record_wisdom') }}">
                                <div class="layer">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <a href="{{ url('show-student-wisdom/' . $wisdomStud->id . '/parent_conference_record_wisdom') }}">
                                <div class="layer">
