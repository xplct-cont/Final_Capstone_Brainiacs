...
@section('content')
    ...
    <div class="container col-md-12 mx-auto" style="position: relative; top: -60px;">
        ...
        <div class="testimotionals">
            <div class="card">
                <a href="{{ url('show-student-wisdom/' . $wisdomStud->id . '/counseling_anecdotal_record_wisdom') }}">
                    <div class="layer">
    ...
    <div class="input-group mb-3 mx-auto" style="width: 300px; margin-top: -30px;">
        <input type="text" name="lastname" class="form-control text-center" value="{{ $wisdomStud->email }}" required>
    </div>
