    ...
    <div class="container" style="">
        <div class="">
            <div class="">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-secondary text-center">
                                    ...
                                    <form action="{{ url('/upload_career_interest_result_wisdom') }}" method="POST"
                ...
                <a href="{{ url('delete_career_interest_test_result_wisdom/' . $car_inter_wis->id) }}"
                    class="btn btn-sm btn-danger mb-1"><i class="text-light fas fa-trash"></i> Delete</a>
                    <a href="{{ route('download_career_interest_test_result_wisdom',$car_inter_wis->id) }}" class="btn btn-sm btn-primary mb-1"><i class="text-light fas fa-download"></i> Download </a>
