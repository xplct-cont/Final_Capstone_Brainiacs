        ...
        <div class="">
            <div class="">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-secondary text-center">
                                    ...
                                    <form action="{{ url('/upload_personality_result_wisdom') }}" method="POST"
                ...
                @forelse ($personality_test_result_wisdom as $personal_wis)
                    <a href="{{ url('delete_personality_test_result_wisdom/' . $personal_wis->id) }}"
                        class="btn btn-sm btn-danger mb-1"><i class="text-light fas fa-trash"></i> Delete</a>
                    <a href="{{ route('download_personality_test_result_wisdom', $personal_wis->id) }}"
