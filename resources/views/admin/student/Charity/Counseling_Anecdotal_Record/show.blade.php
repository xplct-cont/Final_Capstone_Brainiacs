                        ...
                        <div class="form-group mt-3">
                            <p class="text-dark"
                                ...
                                <span class="text-dark" style="font-weight: 500">Gender: </span><span class="text-dark"
                                    style="border-bottom: 1px solid black">{{ $student_char->student->gender }} </span>
                            </p>
                        </div>
                        ...
                        <div class="form-group mt-3">
                            <p class="text-dark"
                                ...
                                <span class="text-dark" style="font-weight: 500">Date/Time Called: </span><span
                                    class="text-dark"
                                    style="border-bottom: 1px solid black">{{ $student_char->date_time_called->format('F d,  Y - g:i A') }} </span>
                            </p>
                        </div>
                        ...
                        <div class="form-group mt-3">
                            <p class="text-dark"
                                ...
                                <span class="text-dark" style="font-weight: 500">Reason/s for Contact: </span><span
                                    class="text-dark"
                                    style="border-bottom: 1px solid black">{{ $student_char->reasons_for_contact }} </span>
                            </p>
                        </div>
                        ...
                        <div class="form-group mt-3">
                            <p class="text-dark"
                                ...
                                <span class="text-dark" style="font-weight: 500">Referred By: </span><span class="text-dark"
                                    style="border-bottom: 1px solid black">{{ $student_char->referred_by }}</span>
                            </p>
                        </div>
                        ...
                        <div class="form-group mt-3">
                            <p class="text-dark"
                                ...
                                <span class="text-dark" style="font-weight: 500">Follow up Counseling Session: </span><span
                                    class="text-dark"
                                    style="border-bottom: 1px solid black">{{ $student_char->follow_up_counseling_session }}</span>
                            </p>
                        </div>
                    </div>
