...
@section('content')
<div class="p-1">
    <a class="fas fa-arrow-left" style="font-size:20px; color:blue;" href="{{ url('show-student-charity/' . $student_char->student->id . '/counseling_anecdotal_record_charity') }}"></a>
</div>
    ...
    <div class="row d-flex justify-content-center text-dark">
        ...
        href="{{ route('export_charityStudents_counseling_anecdotal_pdf', $student_char->id) }}"><span class="fas fa-file-pdf"
            ...
            <div class="container mx-auto">
                ...
                <form action="{{ url('update_counseling_anecdotal_record_charity/' . $student_char->id) }}" method="POST" accept-charset="UTF-8">
                    @csrf
                    @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $student_char->student->firstname }} {{ $student_char->student->middlename }} {{ $student_char->student->lastname }}" readonly>
                        </div>

                        <div class="form-group mt-3">
                            <label for="" style="color:dimgray">Gender: </label>
                            <input type="text" class="form-control" value="{{ $student_char->student->gender }}" readonly>
                        </div>

                        <div class="form-group mt-3">
                            <label for="" style="color:dimgray">Date/Time Called: </label>
                            <input type="text" class="form-control" value="{{ $student_char->date_time_called->format('F d,  Y - g:i A') }}" readonly>
                        </div>

                        <div class="form-group mt-3">
                            <label for="" style="color:dimgray">Reason/s for Contact: </label>
                            <input type="text" class="form-control" name="reasons_for_contact" value="{{ $student_char->reasons_for_contact}}">
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control" value="{{ $student_char->student->age}}" readonly>
                        </div>

                        <div class="form-group mt-3">
                            <label for="" style="color:dimgray">Year/Section: </label>
                            <input type="text" class="form-control" value="{{ $student_char->student->year_section}}" readonly>
                          
                        </div>

                        <div class="form-group mt-3">
                            <label for="" style="color:dimgray">Referred By: </label>
                            <input type="text" class="form-control" name="referred_by" value="{{ $student_char->referred_by}}">
                        </div>

                        <div class="form-group mt-3">
                            <label for="" style="color:dimgray">Follow up Counseling Session: </label>
                            <input type="text" class="form-control" name="follow_up_counseling_session" value="{{ $student_char->follow_up_counseling_session}}">
                    ...
                    <div class="col-md-12 mb-3 mt-2">
                        ...
                        <textarea style="border: solid 1px dimgray; height: 80px;" id="" type="text" class="form-control"
                            placeholder="" title="" name="reasons_for_referral">{{ $student_char->reasons_for_referral }}</textarea>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class=" p-2 bg-light" style="border: 1px solid dimgray;">
                            ...
                            <textarea style="border: solid 1px dimgray; height: 150px;" id="" type="text" class="form-control"
                                placeholder="" title="" name="behavior_observed">{{ $student_char->behavior_observed }}</textarea>
                            <br>
                            <label for="" style="color:dimgray;">Interview Findings</label>
                            <textarea style="border: solid 1px dimgray; height: 150px;" id="" type="text" class="form-control"
                                placeholder="" title="" name="interview_findings">{{ $student_char->interview_findings }}</textarea>
                            <br>
                            <label for="" style="color:dimgray;">Comments/Clinical Impressions</label>
                            <textarea style="border: solid 1px dimgray; height: 150px;" id="" type="text" class="form-control"
                                placeholder="" title="" name="clinical_impressions">{{ $student_char->clinical_impressions }}</textarea>
                            <br>
                            <label for="" style="color:dimgray;">Recommendation</label>
                            <textarea style="border: solid 1px dimgray; height: 150px;" id="" type="text" class="form-control"
                                placeholder="" title="" name="recommendation">{{ $student_char->recommendation }}</textarea>
                            ...
                            <input type="text" class="form-control text-center" style="width: 45px;" name="student_id" value="{{ $student_char->student_id}}" readonly>
