                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="datetime-local" name="observation_date_time" class="form-control"
                                value="{{ $student_char->observation_date_time }}" readonly>

                        </div>
                        <div class="form-group">
                            <label for="" style="color:dimgray;">Lastname</label>
                            <input type="text" name="" class="form-control"
                                value="{{ $student_char->student->lastname }}" readonly>

                        </div>
                        <div class="form-group">
                            <label for="" style="color:dimgray;">Firstname</label>
                            <input type="text" name="" class="form-control"
                                value="{{ $student_char->student->firstname }}" readOnly>

                        </div>
                        <div class="form-group">
                            <label for="" style="color:dimgray;">Middlename</label>
                            <input type="text" name="" class="form-control"
                                value="{{ $student_char->student->middlename }}" readOnly>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="" class="form-control"
                                value="{{ $student_char->student->user->name }}" readOnly>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="" class="form-control"
                                value="{{ $student_char->student->year_section }}" readOnly>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea id="" type="text" class="form-control" placeholder="" title="" rows="5" readonly
                            name="description_of_incident">{{ $student_char->description_of_incident }}</textarea>
                        <br>
                        <label for="" style="color:dimgray;">Description of Location/Setting</label>
                        <textarea id="" type="text" class="form-control" placeholder="" title="" rows="5" readonly
                            name="location_of_incident">{{ $student_char->location_of_incidents }}</textarea>
                        <br>
                        <label for="" style="color:dimgray;">Action Taken</label>
                        <textarea id="" type="text" class="form-control" placeholder="" title="" rows="5" readonly
                            name="action_taken">{{ $student_char->actions_taken }}</textarea>
                        <br>
                        <label for="" style="color:dimgray;">Recommendation</label>
                        <textarea id="" type="text" class="form-control" placeholder="" title="" rows="5" readonly
                            name="recommendations">{{ $student_char->recommendations }}</textarea>
