...
@section('content')
<div class="p-1">
    <a class="fas fa-arrow-left" style="font-size:20px; color:blue;" href="{{ url('show-student-charity/' . $student_char->student->id . '/anecdotal_record_charity') }}"></a>
</div>
    ...
    <div class="row d-flex justify-content-center text-dark">
        ...
        href="{{ route('export_charityStudents_anecdotal_pdf', $student_char->id) }}"><span class="fas fa-file-pdf"
            ...
            <div class="container mx-auto">
                ...
                <form action="{{ url('update_anecdotal_record_charity/' . $student_char->id) }}" method="POST" accept-charset="UTF-8">
                    @csrf
                    @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $student_char->observation_date_time->format('F d,  Y - g:i A') }}" readonly>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $student_char->student->user->name }}" readonly>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-12 mb-3 mt-2">
                        <div class=" p-2 bg-light" style="border: 1px solid dimgray;">
                            ...
                            <textarea style="border: solid 1px dimgray; height: 150px;" id="" type="text" class="form-control"
                                placeholder="" title="" name="description_of_incident">{{ $student_char->description_of_incident }}</textarea>
                            <br>
                            <label for="" style="color:dimgray;">Description of Location/Setting</label>
                            <textarea style="border: solid 1px dimgray; height: 150px;" id="" type="text" class="form-control"
                                placeholder="" title="" name="location_of_incidents">{{ $student_char->location_of_incidents }}</textarea>
                            <br>
                            <label for="" style="color:dimgray;">Action Taken</label>
                            <textarea style="border: solid 1px dimgray; height: 150px;" id="" type="text" class="form-control"
                                placeholder="" title="" name="actions_taken">{{ $student_char->actions_taken }}</textarea>
                            <br>
                            <label for="" style="color:dimgray;">Recommendation</label>
                            <textarea style="border: solid 1px dimgray; height: 150px;" id="" type="text" class="form-control"
                                placeholder="" title="" name="recommendations">{{ $student_char->recommendations }}</textarea>
                            ...
                            <input type="text" class="form-control text-center" style="width: 45px;" name="student_id" value="{{ $student_char->student->id }}" readonly>
                            </div>
                            <br>
