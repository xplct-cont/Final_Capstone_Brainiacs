...
@endif
        <div class="py-5">
            <div class="container">
                <div class="row hidden-md-up">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <a href="{{ url('show-student-charity/' . $charityStud->id . '/anecdotal_record_charity') }}">
                                <div class="layer">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <a
                                href="{{ url('show-student-charity/' . $charityStud->id . '/counseling_anecdotal_record_charity') }}">
                                <div class="layer">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <a href="{{ url('show-student-charity/' . $charityStud->id . '/parent_conference_record_charity') }}">
                                <div class="layer">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <a href="{{ url('show-student-charity/' . $charityStud->id . '/career_interest_test_result_charity') }}">
                                <div class="layer">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <a href="{{ url('show-student-charity/' . $charityStud->id . '/personality_test_result_charity') }}">
                                <div class="layer">
        ...
        <form action="{{ url('/send_email_student_charity') }}" method="POST">
            @csrf
        <div class="input-group mb-3 mx-auto" style="width: 300px; margin-top: -30px;">
            <input type="email" name="email" class="form-control text-center" value="{{ $charityStud->email }}"
                required>
        </div>
            ...
            <div class="container " style="position: relative; top:-40px;">
                <div class="form-group">
                    ...
                    <input type="text" name="subject" class="form-control"
                        value="{{ $charityStud->firstname }} {{ $charityStud->middlename }} {{ $charityStud->lastname }}" required />
                </div>
