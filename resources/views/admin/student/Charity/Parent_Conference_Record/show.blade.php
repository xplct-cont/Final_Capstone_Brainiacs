...
@section('content')
<div class="p-1">
    <a class="fas fa-arrow-left" style="font-size:20px; color:blue;" href="{{ url('show-student-charity/' . $student_char->student->id . '/parent_conference_record_charity') }}"></a>
</div>
    ...
    <div class="row d-flex justify-content-center text-dark">
        <div class="col-md-11 elevation-4 p-3 rounded  mt-5 bg-light mb-3">
            ...
            <form action="{{ url('update_parent_conference_record_charity/' . $student_char->id) }}" method="POST" accept-charset="UTF-8">
                    @csrf
                    @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control" value="{{ $student_char->student->parent_name }}" readonly>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control" value="{{ $student_char->date->format('F d,  Y ') }}" readonly>
                        </div>

                        <div class="form-group ">
                            <label for="" style="color:dimgray">Relation to Student: </label>
                            <input type="text" class="form-control" name="relation_to_student" value="{{ $student_char->relation_to_student}}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="reason_for_contact" value="{{ $student_char->reason_for_contact}}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="" style="color:dimgray">Inquiries/Referral/Appointment:</label>          
                                <input type="text" class="form-control" name="inquiries_referral_appointment" value="{{ $student_char->inquiries_referral_appointment}}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-3 mt-2">
                        ...
                        <div class="form-group text-center ">
                           <div class="col-md-2">
                            ...
                            <input type="text" class="form-control" name="action_taken" value="{{ $student_char->action_taken}}">
                           </div>
                        </div>
