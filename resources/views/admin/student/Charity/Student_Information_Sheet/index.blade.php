...
<div class="p-1">
    ...
    <h1 class="text-dark p-3"
        ...
        Student Information Sheet of {{ $student_cha->lastname }}, {{ $student_cha->firstname }} from
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ url('/upload_student_information_charity') }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $student_cha->age }}"
                                            readonly>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $student_cha->address }}"
                                            readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="" style="color:dimgray">Sex</label>
                                        <input type="text" class="form-control" value="{{ $student_cha->gender }}"
                                            readonly>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" style="width: 50px" class="form-control text-center"
                                            name="student_id" value="{{ $student_cha->id }}" readonly>
                                    </div>
                                </div>
                            </div>
    ...
    @forelse ($student_information_sheet_charity as $stud_info_cha)

    <form action="{{ url('update_student_information_sheet_charity/' . $stud_info_cha->id) }}" method="POST" accept-charset="UTF-8">
        @csrf
        @method('PUT')

        <div class="row d-flex justify-content-center text-dark">
            <div class="col-md-11 elevation-4 p-3 rounded  mt-2 bg-light mb-3">
                <a href="{{ url('delete_student_information_sheet_charity/' . $stud_info_cha->id) }}"
                ...
                <div class="container mx-auto">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mt-5">
                                ...
                                <input type="text" class="form-control" name="type_of_student" value="{{$stud_info_cha->type_of_student}}">
                            </div>
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $stud_info_cha->student->lastname }}, {{ $stud_info_cha->student->firstname }} {{ $stud_info_cha->student->middlename }}" readonly>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="last_attended_school" value="{{ $stud_info_cha->last_attended_school }}">
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="" style="color:dimgray">Year/Section: </label>
                                <input type="text" class="form-control"  value="{{ $stud_info_cha->student->year_section }}" readonly>
                                
                            </div>
                            <div class="form-group ">
                                <label for="" style="color:dimgray">School Year: </label>
                                <input type="text" class="form-control" name="school_year"  value="{{ $stud_info_cha->school_year }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="birthdate"  value="{{$stud_info_cha->birthdate}}">
                            </div>
                            <div class="form-group">
                                <label for="" style="color:dimgray">Nationality: </label>
                                <input type="text" class="form-control" name="nationality"  value="{{ $stud_info_cha->nationality}}">
                    
                            </div>
                            <div class="form-group">
                                <label for="" style="color:dimgray">Status: </label>
                                <input type="text" class="form-control" name="status"  value="{{ $stud_info_cha->status}}">

                               
                            </div>
                            <div class="form-group">
                                <label for="" style="color:dimgray">Age: </label>
                                <input type="text" class="form-control"  value="{{ $stud_info_cha->student->age}}" readonly>

                            </div>
                            <div class="form-group">
                                <label for="" style="color:dimgray">Height: </label>
                                <input type="text" class="form-control" name="height"  value="{{ $stud_info_cha->height}}">
                                
                            </div>
                            <div class="form-group">
                                <label for="" style="color:dimgray">Mobile Number: </label>
                                <input type="text" class="form-control" name="number"  value="{{ $stud_info_cha->number}}">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="" style="color:dimgray">Place of Birth: </label>
                                <input type="text" class="form-control" name="birthplace"  value="{{ $stud_info_cha->birthplace}}">
                             
                            </div>
                            <div class="form-group ">
                                <label for="" style="color:dimgray">Religion: </label>
                                <input type="text" class="form-control" name="religion"  value="{{ $stud_info_cha->religion}}">
                            ...
                            <div class="form-group ">
                                <label for="" style="color:dimgray">Sex: </label>
                                <input type="text" class="form-control" value="{{ $stud_info_cha->student->gender}}" readonly>
                               
                            </div>
                            <div class="form-group ">
                                <label for="" style="color:dimgray">Weight: </label>
                                <input type="text" class="form-control" name="weight"  value="{{ $stud_info_cha->weight}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group ">
                                <label for="" style="color:dimgray">Elementary: </label>
                                <input type="text" class="form-control" name="elementary"  value="{{ $stud_info_cha->elementary}}">
                            </div>
                            <div class="form-group ">
                                <label for="" style="color:dimgray">Secondary: </label>
                                <input type="text" class="form-control" name="secondary"  value="{{ $stud_info_cha->secondary}}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group ">
                                <label for="" style="color:dimgray">Elementary Honor/s Received: </label>
                                <input type="text" class="form-control" name="elem_honors_rec"  value="{{ $stud_info_cha->elem_honors_rec}}">
                              
                            </div>
                            <div class="form-group ">
                                <label for="" style="color:dimgray">Secondary Honor/s Received: </label>
                                <input type="text" class="form-control" name="secon_honors_rec"  value="{{ $stud_info_cha->secon_honors_rec}}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group ">
                                <div class="form-group ">
                                    <label for="" style="color:dimgray">Year Graduated in Elementary: </label>
                                    <input type="text" class="form-control" name="elem_year_grad"  value="{{ $stud_info_cha->elem_year_grad}}">
                            ...
                            <div class="form-group">
                                <label for="" style="color:dimgray">Year Graduated in Secondary: </label>
                                <input type="text" class="form-control" name="secon_year_grad"  value="{{ $stud_info_cha->secon_year_grad}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="" style="color:dimgray">Year Level Last Attended: </label>
                                <input type="text" class="form-control" name="level_last_attended"  value="{{ $stud_info_cha->level_last_attended}}">

                            </div>
                            <div class="form-group">
                                <label for="" style="color:dimgray">Reason/s why transfer: </label>
                                <input type="text" class="form-control" name="reasons_for_transfer"  value="{{ $stud_info_cha->reasons_for_transfer}}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="" style="color:dimgray">School and Address: </label>
                                <input type="text" class="form-control" name="school_add"  value="{{ $stud_info_cha->school_add}}">                        
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="" style="color:dimgray">Year: </label>
                                <input type="text" class="form-control" name="year"  value="{{ $stud_info_cha->year}}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="" style="color:dimgray">Name of Organization: </label>
                                <input type="text" class="form-control" name="org_name"  value="{{ $stud_info_cha->org_name}}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="" style="color:dimgray">Position: </label>
                                <input type="text" class="form-control" name="position"  value="{{ $stud_info_cha->position}}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="" style="color:dimgray">Year: </label>
                                <input type="text" class="form-control" name="org_year"  value="{{ $stud_info_cha->org_year}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="" style="color:dimgray">Favorite Subject: </label>
                                <input type="text" class="form-control" name="fav_sub"  value="{{ $stud_info_cha->fav_sub}}">

                            </div>
                            <div class="form-group">
                                <label for="" style="color:dimgray">Likes: </label>
                                <input type="text" class="form-control" name="likes"  value="{{ $stud_info_cha->likes}}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="" style="color:dimgray">Most Difficult Subject: </label>
                                <input type="text" class="form-control" name="most_dif_sub"  value="{{ $stud_info_cha->most_dif_sub}}">

                              
                            </div>
                            <div class="form-group">
                                <label for="" style="color:dimgray">Dislikes: </label>
                                <input type="text" class="form-control" name="dislikes"  value="{{ $stud_info_cha->dislikes}}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="" style="color:dimgray">Interest/Hobbies: </label>
                                <input type="text" class="form-control" name="hobbies"  value="{{ $stud_info_cha->hobbies}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="" style="color:dimgray">Father: </label>
                                <input type="text" class="form-control" name="father"  value="{{ $stud_info_cha->father}}">
                            ...
                            <div class="form-group">
                                <label for="" style="color:dimgray">Occupation: </label>
                                <input type="text" class="form-control" name="father_occupation"  value="{{ $stud_info_cha->father_occupation}}">

                             
                            </div>
                            <div class="form-group">
                                <label for="" style="color:dimgray">Office Address: </label>
                                <input type="text" class="form-control" name="father_off_ad"  value="{{ $stud_info_cha->father_off_ad}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="" style="color:dimgray">Mother: </label>
                                <input type="text" class="form-control" name="mother"  value="{{ $stud_info_cha->mother}}">

                            </div>
                            <div class="form-group">
                                <label for="" style="color:dimgray">Age: </label>
                                <input type="text" class="form-control" name="mother_age"  value="{{ $stud_info_cha->mother_age}}">

                            </div>
                            <div class="form-group">
                                <label for="" style="color:dimgray">Occupation: </label>
                                <input type="text" class="form-control" name="mother_occupation"  value="{{ $stud_info_cha->mother_occupation}}">

                            </div>
                            <div class="form-group">
                                <label for="" style="color:dimgray">Office Address: </label>
                                <input type="text" class="form-control" name="mother_off_ad"  value="{{ $stud_info_cha->mother_off_ad}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="father_educ_stat"  value="{{ $stud_info_cha->father_educ_stat}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="mother_educ_stat"  value="{{ $stud_info_cha->mother_educ_stat}}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="monthly_income"  value="{{ $stud_info_cha->monthly_income}}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="mar_parents_stat"  value="{{ $stud_info_cha->mar_parents_stat}}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="rank_order"  value="{{ $stud_info_cha->rank_order}}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="" style="color:dimgray">No. of Brothers: </label>
                                <input type="text" class="form-control" name="no_of_brothers"  value="{{ $stud_info_cha->no_of_brothers}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="" style="color:dimgray">No. of Sisters: </label>
                                <input type="text" class="form-control" name="no_of_sisters"  value="{{ $stud_info_cha->no_of_sisters}}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="living_with"  value="{{ $stud_info_cha->living_with}}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="how_are_you_supp"  value="{{ $stud_info_cha->how_are_you_supp}}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="" style="color:dimgray">Father: </label>
                                <input type="text" class="form-control" name="rel_with_father"  value="{{ $stud_info_cha->rel_with_father}}">

                            </div>
                            <div class="form-group">
                                <label for="" style="color:dimgray">Mother: </label>
                                <input type="text" class="form-control" name="rel_with_mother"  value="{{ $stud_info_cha->rel_with_mother}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="" style="color:dimgray">Brother: </label>
                                <input type="text" class="form-control" name="rel_with_brother"  value="{{ $stud_info_cha->rel_with_brother}}">

                            </div>
                            <div class="form-group">
                                <label for="" style="color:dimgray">Sister: </label>
                                <input type="text" class="form-control" name="rel_with_sister"  value="{{ $stud_info_cha->rel_with_sister}}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="" style="color:dimgray">Name of Spouse: </label>
                                <input type="text" class="form-control" name="spouse_name"  value="{{ $stud_info_cha->spouse_name}}">

                            </div>
                            <div class="form-group">
                                <label for="" style="color:dimgray">Occupation: </label>
                                <input type="text" class="form-control" name="spouse_occupation"  value="{{ $stud_info_cha->spouse_occupation}}">

                            </div>
                            <div class="form-group">
                                <label for="" style="color:dimgray">Nationality: </label>
                                <input type="text" class="form-control" name="spouse_nationality"  value="{{ $stud_info_cha->spouse_nationality}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="" style="color:dimgray">Age: </label>
                                <input type="text" class="form-control" name="spouse_age"  value="{{ $stud_info_cha->spouse_age}}">

                            </div>
                            <div class="form-group">
                                <label for="" style="color:dimgray">Name and Address of Company: </label>
                                <input type="text" class="form-control" name="spouse_comp_name"  value="{{ $stud_info_cha->spouse_comp_name}}">

                            </div>
                            <div class="form-group">
                                <label for="" style="color:dimgray">Company Tel/Mobile No.: </label>
                                <input type="text" class="form-control" name="company_num"  value="{{ $stud_info_cha->company_num}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="" style="color:dimgray">Past Disease: </label>
                                <input type="text" class="form-control" name="past_disease"  value="{{ $stud_info_cha->past_disease}}">

                              
                            </div>
                            <div class="form-group">
                                <label for="" style="color:dimgray">Injuries of Illness: </label>
                                <input type="text" class="form-control" name="injuries"  value="{{ $stud_info_cha->injuries}}">
                             
                            </div>
                            <div class="form-group">
                                <label for="" style="color:dimgray">Previous Hospitalization/Operations: </label>
                                <input type="text" class="form-control" name="operations"  value="{{ $stud_info_cha->operations}}">

                            </div>
                            <div class="form-group">
                                <label for="" style="color:dimgray">Menstrual History (Female Only): </label>
                                <input type="text" class="form-control" name="mens_history"  value="{{ $stud_info_cha->mens_history}}">
                    ...
                    <p class="text-dark mt-2 mb-5"><i class="text-dark">I certify that all information above are true
                          ...
                          <div class="row">
                            <div class="col-md-4">
                                <label for="" style="color:dimgray">Date Signed: </label>
                                <div style="font-size:15px;">YYYY-MM-DD</div>
                                <input type="text" class="form-control" name="date_signed"  value="{{$stud_info_cha->date_signed->format('Y-m-d')}}">
                          
                                <label for="" style="color:dimgray">Student ID: </label>
                                <input type="text" class="form-control text-center" style="width: 45px;" name="student_id"  value="{{$stud_info_cha->student_id}}" readonly>
                            </div>
                          </div>
                    <br>
