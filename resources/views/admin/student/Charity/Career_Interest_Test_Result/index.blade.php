...
<div class="p-1">
    ...
    <h1 class="text-dark p-3"
        ...
        Career Interest Test Result of {{ $student_cha->lastname }}, {{ $student_cha->firstname }} from
    ...
    <div class="container" style="">
        <div class="">
            <div class="">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-secondary text-center">
                                    ...
                                    <form action="{{ url('/upload_career_interest_result_charity') }}" method="POST"
                ...
                @forelse ($career_interest_test_result_charity as $car_inter_cha)
                    <a href="{{ url('delete_career_interest_test_result_charity/' . $car_inter_cha->id) }}"
                        class="btn btn-sm btn-danger mb-1"><i class="text-light fas fa-trash"></i> Delete</a>
                        <a href="{{ route('download_career_interest_test_result_charity',$car_inter_cha->id) }}" class="btn btn-sm btn-primary mb-1"><i class="text-light fas fa-download"></i> Download </a>
                    <img src="{{ asset('storage/career_interest_test_result/' . $car_inter_cha->interest_result) }} "
