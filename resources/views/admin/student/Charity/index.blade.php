        ...
        <div class="mx-auto" style="width:400px;">
            <form action="{{ route('charity-list') }}" method="GET" role="search">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control mr-2" name="charity" placeholder="Search Full Name"
                        id="charity">
                        ...
                        <div class="card-body">
                            <div class="" style="position: relative; top:-20px;">
                                <a class="btn btn-danger mt-2 ml-2" style=""
                                    href="{{ route('export_charityStudents_pdf') }}"><span class="fas fa-arrow-circle-down"
                                        style="font-size: 15px;"></span> Export PDF</a>
                                <a href="/export_charityStudents_excel" class=" mt-2 ml-4 btn btn-success"><span
