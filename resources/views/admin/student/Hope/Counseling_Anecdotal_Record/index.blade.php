...
<div class="p-1">
    ...
    <h1 class="text-dark p-3"
        ...
        Counseling Anecdotal Records of {{ $student_hop->lastname }}, {{ $student_hop->firstname }} from
        ...
        <div class="card">
            <div class="card-header text-center">
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ url('show-student-hope/' . $student_hop->id . '/counseling_anecdotal_record_hope/create/') }}"
                ...
                <table class="table table-striped table-sm text-dark text-center bg-light">
                    ...
                    <tbody>
                        @forelse ($counseling_anecdotal_hope as $coun_anec_hop)
                            <tr>
                                <td class="text-dark">{{ $coun_anec_hop->date_time_called->format('F d,  Y - g:i A') }}</td>
                                <td class="text-dark">{{ $coun_anec_hop->reasons_for_contact }}</td>
                                <td><a href="{{ url('/show-student-hope/'.$coun_anec_hop->student->id.'/counseling_anecdotal_record_hope/' . $coun_anec_hop->id) }}"
                                        class="btn btn-xs "><i class="fas fa-search text-info"></i></a></td>
                                <td><a href="{{ url('delete_counseling_anecdotal_record_hope/' . $coun_anec_hop->id) }}"
