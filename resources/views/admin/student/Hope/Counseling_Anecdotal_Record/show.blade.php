                ...
                <div class="row">
                        ...
                        <div class="form-group mt-3">
                            <p class="text-dark"
                                ...
                                <span class="text-dark" style="font-weight: 500">Date/Time Called: </span><span
                                    class="text-dark"
                                    style="border-bottom: 1px solid black">{{ $student_hope->date_time_called }} </span>
                            </p>
                        </div>
                    ...
                    <div class="col-md-12 mb-3 mt-2">
                        ...
                        <textarea style="border: solid 1px dimgray; height: 80px;" id="" type="text" class="form-control"
                            placeholder="" title="" name="reasons_for_referral">{{ $student_hope->reasons_for_referral }}</textarea>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class=" p-2 bg-light" style="border: 1px solid dimgray;">
                            ...
                            <textarea style="border: solid 1px dimgray; height: 150px;" id="" type="text" class="form-control"
                                placeholder="" title="" name="behavior_observed">{{ $student_hope->behavior_observed }}</textarea>
                            <br>
                            <label for="" style="color:dimgray;">Interview Findings</label>
                            <textarea style="border: solid 1px dimgray; height: 150px;" id="" type="text" class="form-control"
                                placeholder="" title="" name="interview_findings">{{ $student_hope->interview_findings }}</textarea>
                            <br>
                            <label for="" style="color:dimgray;">Comments/Clinical Impressions</label>
                            <textarea style="border: solid 1px dimgray; height: 150px;" id="" type="text" class="form-control"
                                placeholder="" title="" name="clinical_impressions">{{ $student_hope->clinical_impressions }}</textarea>
                            <br>
                            <label for="" style="color:dimgray;">Recommendation</label>
                            <textarea style="border: solid 1px dimgray; height: 150px;" id="" type="text" class="form-control"
                                placeholder="" title="" name="recommendation">{{ $student_hope->recommendation }}</textarea>
