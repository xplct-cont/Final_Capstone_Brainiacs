...
@section('content')
<div class="p-1">
    <a class="fas fa-arrow-left" style="font-size:20px; color:blue;" href="{{ url('show-student-hope/' . $student_hope->student->id . '/parent_conference_record_hope') }}"></a>
</div>
    ...
    <div class="row d-flex justify-content-center text-dark">
        ...
        href="{{ route('export_hopeStudents_parent_conference_record_pdf', $student_hope->id) }}"><span class="fas fa-file-pdf"
            ...
            <div class="container mx-auto">
                ...
                <form action="{{ url('update_parent_conference_record_hope/' . $student_hope->id) }}" method="POST" accept-charset="UTF-8">
                    @csrf
                    @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control" value="{{ $student_hope->student->parent_name }}" readonly>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control" value="{{ $student_hope->date->format('F d,  Y ') }}" readonly>
                        </div>

                        <div class="form-group ">
                            <label for="" style="color:dimgray">Relation to Student: </label>
                            <input type="text" class="form-control" name="relation_to_student" value="{{ $student_hope->relation_to_student}}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="reason_for_contact" value="{{ $student_hope->reason_for_contact}}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="" style="color:dimgray">Inquiries/Referral/Appointment:</label>          
                                <input type="text" class="form-control" name="inquiries_referral_appointment" value="{{ $student_hope->inquiries_referral_appointment}}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-3 mt-2">
                        ...
                        <textarea style="border: solid 1px dimgray; height: 120px;" id="" type="text" class="form-control"
                            placeholder="" title="" name="problem_concern">{{ $student_hope->problem_concern }}</textarea>
                        <br>
                        <label for="" style="color:dimgray;">Topics Discussed</label>
                        <textarea style="border: solid 1px dimgray; height: 120px;" id="" type="text" class="form-control"
                            placeholder="" title="" name="topics_discussed">{{ $student_hope->topics_discussed }}</textarea>
                        <br>
                        <label for="" style="color:dimgray;">Suggested Resolution</label>
                        <textarea style="border: solid 1px dimgray; height: 120px;" id="" type="text" class="form-control"
                            placeholder="" title="" name="suggested_resolution">{{ $student_hope->suggested_resolution }}</textarea>
                        <br>

                        <div class="form-group text-center ">
                           <div class="col-md-2">
                            <label for="" style="color:dimgray">Action Taken: </label>
                            <input type="text" class="form-control" name="action_taken" value="{{ $student_hope->action_taken}}">
                           </div>
                        </div>
