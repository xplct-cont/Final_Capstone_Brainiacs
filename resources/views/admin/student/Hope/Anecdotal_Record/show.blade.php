...
@section('content')
<div class="p-1">
    <a class="fas fa-arrow-left" style="font-size:20px; color:blue;" href="{{ url('show-student-hope/' . $student_hope->student->id . '/anecdotal_record_hope') }}"></a>
</div>
    ...
    <div class="row d-flex justify-content-center text-dark">
        ...
        href="{{ route('export_hopeStudents_anecdotal_pdf', $student_hope->id) }}"><span class="fas fa-file-pdf"
            ...
            <div class="container mx-auto">
                ...
                <form action="{{ url('update_anecdotal_record_hope/' . $student_hope->id) }}" method="POST" accept-charset="UTF-8">
                    @csrf
                    @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $student_hope->observation_date_time->format('F d,  Y - g:i A') }}" readonly>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $student_hope->student->user->name }}" readonly>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-12 mb-3 mt-2">
                        <div class=" p-2 bg-light" style="border: 1px solid dimgray;">
                            ...
                            <textarea style="border: solid 1px dimgray; height: 150px;" id="" type="text" class="form-control"
                                placeholder="" title="" name="description_of_incident">{{ $student_hope->description_of_incident }}</textarea>
                            <br>
                            <label for="" style="color:dimgray;">Description of Location/Setting</label>
                            <textarea style="border: solid 1px dimgray; height: 150px;" id="" type="text" class="form-control"
                                placeholder="" title="" name="location_of_incidents">{{ $student_hope->location_of_incidents }}</textarea>
                            <br>
                            <label for="" style="color:dimgray;">Action Taken</label>
                            <textarea style="border: solid 1px dimgray; height: 150px;" id="" type="text" class="form-control"
                                placeholder="" title="" name="actions_taken">{{ $student_hope->actions_taken }}</textarea>
                            <br>
                            <label for="" style="color:dimgray;">Recommendation</label>
                            <textarea style="border: solid 1px dimgray; height: 150px;" id="" type="text" class="form-control"
                                placeholder="" title="" name="recommendations">{{ $student_hope->recommendations }}</textarea>
                            ...
                            <input type="text" class="form-control text-center" style="width: 45px;" name="student_id" value="{{ $student_hope->student->id }}" readonly>
                            </div>
                            <br>
