...
@section('content')
<div class="p-1">
    <a class="fas fa-arrow-left" style="font-size:20px; color:blue;" href="{{ url('hope-students')}}"></a>
</div>
    <body>
...
@endif
        <div class="py-5">
            <div class="container">
                <div class="row hidden-md-up">
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <a href="{{ url('show-student-hope/' . $hopeStud->id . '/student_information_sheet_hope') }}">
                                <div class="layer">
                                </div>
                                <div class="content">
                                    <div class="div">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <a href="{{ url('show-student-hope/' . $hopeStud->id . '/parent_conference_record_hope') }}">
                                <div class="layer">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <a href="{{ url('show-student-hope/' . $hopeStud->id . '/career_interest_test_result_hope') }}">
                                <div class="layer">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <a href="{{ url('show-student-hope/' . $hopeStud->id . '/personality_test_result_hope') }}">
                                <div class="layer">
        ...
        <form action="{{ url('/send_email_student_hope') }}" method="POST">
            @csrf
        <div class="input-group mb-3 mx-auto" style="width: 300px; margin-top: -30px;">
            <input type="email" name="email" class="form-control text-center" value="{{ $hopeStud->email }}"
                required>
        </div>
            ...
            <div class="container " style="position: relative; top:-40px;">
                <div class="form-group">
                    ...
                    <input type="text" name="subject" class="form-control"
                        value="{{ $hopeStud->firstname }} {{ $hopeStud->middlename }} {{ $hopeStud->lastname }}" required />
                </div>
