...
@section('content')
<div class="p-1">
    <a class="fas fa-arrow-left" style="font-size:20px; color:blue;" href="{{ url('love-students')}}"></a>
</div>
    <body>
        ...
        <div class="py-5">
            <div class="container">
                <div class="row hidden-md-up">
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <a href="{{ url('show-student-love/' . $loveStud->id . '/student_information_sheet_love') }}">
                                <div class="layer">
                                </div>
                                <div class="content">
                                    <div class="div">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <a
                                href="{{ url('show-student-love/' . $loveStud->id . '/counseling_anecdotal_record_love') }}">
                                <div class="layer">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <a href="{{ url('show-student-love/' . $loveStud->id . '/career_interest_test_result_love') }}">
                                <div class="layer">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <a href="{{ url('show-student-love/' . $loveStud->id . '/personality_test_result_love') }}">
                                <div class="layer">
