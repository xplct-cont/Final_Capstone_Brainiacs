...
<div class="p-3">
    <a class="fas fa-arrow-left" style="font-size:20px; color:blue;" href="{{ url('show-student-love/' . $student_lov->id . '/parent_conference_record_love') }}"></a>
</div>
    ...
    <div class="row d-flex justify-content-center text-dark">
        <div class="col-md-11 elevation-1 p-3 mb-3 rounded bg-light">
            ...
            <div class="container mb-0">
                <form action="{{ url('/add_parent_conference_record_love') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="text" class="form-control" value="{{ $student_lov->parent_name }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $student_lov->age }}" readonly>
