                        ...
                        <div class="form-group mt-5">
                            <p class="text-dark"
                                ...
                                <span class="text-dark" style="font-weight: 500">Observation Date and Time: </span><span
                                    class="text-dark"
                                    style="border-bottom: 1px solid black">{{ $student_love->observation_date_time->format('F d,  Y - g:i A') }}</span>
                            </p>
                        </div>
                        ...
                        <div class="form-group mt-5">
                            <p class="text-dark"
                                ...
                                <span class="text-dark" style="font-weight: 500">Observer/Class Adviser: </span><span
                                    class="text-dark"
                                    style="border-bottom: 1px solid black">{{ $student_love->student->user->name }}</span>
                            </p>
                        </div>
