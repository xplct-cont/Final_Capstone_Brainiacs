...
<div class="search" style="position:relative; top: 5px;" >
  ...
  <form action="{{route('love-list')}}" method="GET" role="search">
      ...
      <div class="input-group">
          ...
          <input type="text" class="form-control mr-2" name="love" placeholder="Search Full Name" id="love">
            ...
            <div class="col-md-12">
                <div class="card bg-dark">
                    <div class="card-header elevation-2" style="height: 60px;">
                        <h4 style="position: absolute; left:38%; color:whitesmoke;">Grade 12 - Love Students</h4>
                    ...
                    <div class="card-body">
                        <div class="" style="position: relative; top:-20px;">
                           <a class="btn btn-danger mt-2 ml-2" style="" href="{{route('export_loveStudents_pdf')}}"><span class="fas fa-arrow-circle-down" style="font-size: 15px;"></span> Export PDF</a>
                            <a href="/export_loveStudents_excel" class=" mt-2 ml-4 btn btn-success"><span class="fas fa-arrow-circle-down" style="font-size: 15px;"></span> Export Excel</a>
                      
                                <div class="d-flex justify-content-end">
                                    <p>Number of students : {{$love}}</p>
                                </div>
                       ...
                       <table class="table table-hover bg-light table-sm elevation-2" style="margin:auto; position:relative; top: -20px;">
                           ...
                           <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="5" class="text-dark"><span class="fas fa-exclamation-circle text-danger"></span> No Grade 12 - Love students found!</td>
                            </tr>
                            @endforelse
