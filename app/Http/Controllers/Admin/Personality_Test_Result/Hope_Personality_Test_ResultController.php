...
class Hope_Personality_Test_ResultController extends Controller
{
    ...
    public function index($id){
        ...
        $personality_test_result_hope = Personality_Test_Result::with(['student'])->where('student_id', '=', $id)->get();
        
  
        $student_hop = Student::find($id);
        return view('admin.student.Hope.Personality_Test_Result.index', compact('personality_test_result_hope', 'student_hop'));
      }
      ...
      {
          $hopeStudents_personality_test_result = Personality_Test_Result::findOrFail($id);
          $pdf = PDF::loadVIew('pdf.hope-personality_test_result', [
              'personality_test_results' => $hopeStudents_personality_test_result
          ]);
  
          return $pdf->download('Hope-Personality Test Result.pdf');
      }
}