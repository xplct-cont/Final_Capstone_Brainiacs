...
class Love_Personality_Test_ResultController extends Controller
{
    ...
    public function index($id){
        ...
        $personality_test_result_love = Personality_Test_Result::with(['student'])->where('student_id', '=', $id)->get();
        
  
        $student_lov = Student::find($id);
        return view('admin.student.Love.Personality_Test_Result.index', compact('personality_test_result_love', 'student_lov'));
      }
      ...
      {
          $loveStudents_personality_test_result = Personality_Test_Result::findOrFail($id);
          $pdf = PDF::loadVIew('pdf.love-personality_test_result', [
              'personality_test_results' => $loveStudents_personality_test_result
          ]);
  
          return $pdf->download('Love-Personality Test Result.pdf');
      }
}