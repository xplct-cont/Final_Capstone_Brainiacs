...
class Wisdom_Personality_Test_ResultController extends Controller
{
    ...
    public function index($id){
      ...
      {
          $wisdomStudents_personality_test_result = Personality_Test_Result::findOrFail($id);
          $pdf = PDF::loadVIew('pdf.wisdom-personality_test_result', [
              'personality_test_results' => $wisdomStudents_personality_test_result
          ]);
  
          return $pdf->download('Wisdom-Personality Test Result.pdf');
      }
}