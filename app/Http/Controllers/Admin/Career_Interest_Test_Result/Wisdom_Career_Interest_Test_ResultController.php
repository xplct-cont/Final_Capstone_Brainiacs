...
class Wisdom_Career_Interest_Test_ResultController extends Controller
{
    ...
    public function destroy($id){
      ...
      {
          $wisdomStudents_career_interest_test_result = Career_Interest_Test_Result::findOrFail($id);
          $pdf = PDF::loadVIew('pdf.wisdom-career_interest_test_result', [
              'career_interest_test_results' => $wisdomStudents_career_interest_test_result
          ]);
  
          return $pdf->download('Wisdom-Career Interest Test Result.pdf');
      }
}