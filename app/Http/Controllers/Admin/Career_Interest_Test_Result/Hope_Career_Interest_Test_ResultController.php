...
class Hope_Career_Interest_Test_ResultController extends Controller
{
    ...
    public function index($id){
      ...
      $career_interest_test_result_hope = Career_Interest_Test_Result::with(['student'])->where('student_id', '=', $id)->get();
      

      $student_hop = Student::find($id);
      return view('admin.student.Hope.Career_Interest_Test_Result.index', compact('career_interest_test_result_hope', 'student_hop'));
    }
    ...
    public function destroy($id){
      ...
      {
          $hopeStudents_career_interest_test_result = Career_Interest_Test_Result::findOrFail($id);
          $pdf = PDF::loadVIew('pdf.hope-career_interest_test_result', [
              'career_interest_test_results' => $hopeStudents_career_interest_test_result
          ]);
  
          return $pdf->download('Hope-Career Interest Test Result.pdf');
      }
}