...
class Love_Career_Interest_Test_ResultController extends Controller
{
    ...
    public function index($id){
      ...
      $career_interest_test_result_love = Career_Interest_Test_Result::with(['student'])->where('student_id', '=', $id)->get();
      

      $student_lov = Student::find($id);
      return view('admin.student.Love.Career_Interest_Test_Result.index', compact('career_interest_test_result_love', 'student_lov'));
    }
    ...
    public function destroy($id){
      ...
      {
          $loveStudents_career_interest_test_result = Career_Interest_Test_Result::findOrFail($id);
          $pdf = PDF::loadVIew('pdf.love-career_interest_test_result', [
              'career_interest_test_results' => $loveStudents_career_interest_test_result
          ]);
  
          return $pdf->download('Love-Career Interest Test Result.pdf');
      }
}