...
class Faith_Anecdotal_RecordController extends Controller
{
    ...
    public function show(Student $id, $student){
        ...
        $student_fait = Anecdotal_Record::with(['student'])->find($student);
      ...
      try{
        ...
        return view('admin.student.Faith.Anecdotal_Record.show', compact( 'student_fait'))->with('student_f', $student_f);
    }
    ...
    public function update(Request $request, $id){
        $student_fai = Anecdotal_Record::find($id);
        $student_fai->student_id = $request->input('student_id');
        // $student_fai->observation_date_time = $request->input('observation_date_time');
        $student_fai->description_of_incident = $request->input('description_of_incident');
        $student_fai->location_of_incidents = $request->input('location_of_incidents');
        $student_fai->actions_taken = $request->input('actions_taken');
        $student_fai->recommendations = $request->input('recommendations');
    ...
    public function destroy($id){
      ...
      public function export_faithStudents_Anecdotal_ID_pdf(Request $request, $id){
        ...
        return $pdf->download('Anecdotal Record-Faith.pdf');
    }
