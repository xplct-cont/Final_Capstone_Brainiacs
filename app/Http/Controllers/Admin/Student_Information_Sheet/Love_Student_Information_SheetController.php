...
class Love_Student_Information_SheetController extends Controller
{
    ...
    public function index($id){
        ...
        $student_information_sheet_love = Student_Information_Sheet::with(['student'])->where('student_id', '=', $id)->get();
        
  
        $student_lov = Student::find($id);
        return view('admin.student.Love.Student_Information_Sheet.index', compact('student_information_sheet_love', 'student_lov'));
      }
